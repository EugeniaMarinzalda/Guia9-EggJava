...
import guia9.ejer6.ServiceClase.ServiceClase;
...
public class Guia9Ejer6 {
    ...
    public static void main(String[] args) {
       Curso a = ServiceClase.crearCurso();
        System.out.println("La ganancia semanal es $ " + ServiceClase.calcularGananciaSemanal(a) );
